...
A partial collection of open source Python modules developed for the **Secuditor project**. All **[modules](/scripts)** in this repository are **standalone** and **[MIT-licensed](LICENSE)**, some may require the installation of third party packages.
